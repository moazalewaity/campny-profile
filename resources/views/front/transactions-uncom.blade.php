                    ...
                    <div class="row">              
                        <table width="100%" dir="ltr" align="center" border="0" cellpadding="2" cellspacing="2">     
                          <tr bgcolor="#666666" style="color:#FFF; font-weight:bold">
                                <td align="center">حالة المعاملة</td>
                        ...
                        @foreach($db_all as $i=>$row)
                          <tr >    
                            <td width="20%"  align="center" >{{ $row->app_desc }}</td>
                            <td width="15%"  align="right">{{ $row->app_date }}</td>
                            <td width="45%"  align="right">{{ $row->to_owner_name }}</td>
                            <td width="15%"  align="center">{{ $row->app_no }}</td>
