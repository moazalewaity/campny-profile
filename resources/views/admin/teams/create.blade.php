...
@section('title','اضافة '.$teamsInfo['title'])
			...
			<div class="col-md-12">
				<div class="tabbable tabbable-custom tabbable-noborder tabbable-reversed">
					...
					<div class="tab-content">
						<form method="POST" action="{{ url('/adminpanel/'.$teamsInfo['teams'].'/create/'.$id) }}" enctype="multipart/form-data">
							{{ csrf_field() }}
									...
									<div class="row">
										...
										<div class="col-md-12">
											<div class="form-group form-md-line-input">
												...
												<div class="col-md-10">
													<input type="text" class="form-control" id="jobTitlt" name="jobTitlt" value="{{ $data->jobTitlt or '' }}">
												</div>
												@if ($errors->has('jobTitlt'))
												<span class="invalid-feedback" role="alert">
													<strong>{{ $errors->first('jobTitlt') }}</strong>
												</span>
												@endif
											</div>
										</div>
										...
										<div class="col-md-12">
											<div class="form-group form-md-line-input">
												...
												<div class="col-md-10">
													<input type="text" class="form-control" id="jobTitlt_en" name="jobTitlt_en" value="{{ $data->jobTitlt_en or '' }}">
												</div>
												@if ($errors->has('jobTitlt_en'))
												<span class="invalid-feedback" role="alert">
													<strong>{{ $errors->first('jobTitlt_en') }}</strong>
												</span>
												@endif
											</div>
										</div>
										...
										<div class="col-md-12">
											<div class="form-group form-md-line-input">
												...
												<div class="col-md-10">
													<input type="text" class="form-control" id="in_url" name="in_url" value="{{ $data->in_url or '' }}">
												</div>
												@if ($errors->has('in_url'))
												<span class="invalid-feedback" role="alert">
													<strong>{{ $errors->first('in_url') }}</strong>
												</span>
												@endif
											</div>
										</div>
										...
										<div class="col-md-12">
											<div class="form-group form-md-line-input">
												...
												<div class="col-md-10">
													<input type="text" class="form-control" id="fb_url" name="fb_url" value="{{ $data->fb_url or '' }}">
												</div>
										...
										<div class="col-md-12">
											<div class="form-group form-md-line-input">
												...
												<div class="col-md-10">
													<input type="text" class="form-control" id="t_url" name="t_url" value="{{ $data->t_url or '' }}">
												</div>
												@if ($errors->has('t_url'))
												<span class="invalid-feedback" role="alert">
...
$.ajax({
url: "{{ url('/adminpanel/'.$teamsInfo['teams'].'/resort') }}",
type: "post",
data: {
"_token":"{{ csrf_token() }}",
"item":item
...
console.log(item);
			...
			$("#my-dropzone").dropzone({
					url: "{{ url('/adminpanel/'.$teamsInfo['teams'].'/imageupload/'.$id) }}",
