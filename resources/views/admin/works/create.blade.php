...
@section('title','اضافة '.$worksInfo['title'])
			...
			<div class="col-md-12">
				<div class="tabbable tabbable-custom tabbable-noborder tabbable-reversed">
					...
					<div class="tab-content">
						<form method="POST" action="{{ url('/adminpanel/'.$worksInfo['works'].'/create/'.$id) }}" enctype="multipart/form-data">
							{{ csrf_field() }}
									...
									<div class="row">
										...
										<div class="col-md-12">
											<div class="form-group form-md-line-input">
												...
												<div class="col-md-10">
													<input type="text" class="form-control" id="title_en" name="title_en" value="{{ $data->title_en or '' }}">
												</div>
										...
										<div class="col-md-12">
											<div class="form-group form-md-line-input">
												...
												<div class="col-md-10">
													<input type="text" class="form-control" id="client" name="client" value="{{ $data->client or '' }}">
												</div>
										...
										<div class="col-md-12">
											<div class="form-group form-md-line-input">
												...
												<div class="col-md-10">
													<input type="date" class="form-control" id="date" name="date" value="{{ $data->date or '' }}">
												</div>
												@if ($errors->has('date'))
												<span class="invalid-feedback" role="alert">
										...
										<div class="col-md-12">
											<div class="form-group form-md-line-input">
												...
												<div class="col-md-10">
													<input type="text" class="form-control"  name="url_work" value="{{ $data->url or '' }}">
												</div>
												@if ($errors->has('url'))
												<span class="invalid-feedback" role="alert">
										...
										<div class="col-md-12">
											<div class="form-group form-md-line-input">
												...
												@if ($errors->has('descrption_en'))
												<span class="invalid-feedback" role="alert">
													<strong>{{ $errors->first('descrption_en') }}</strong>
												</span>
												@endif
											</div>
										</div>
...
$.ajax({
url: "{{ url('/adminpanel/'.$worksInfo['works'].'/resort') }}",
type: "post",
data: {
"_token":"{{ csrf_token() }}",
"item":item
...
console.log(item);
			...
			$("#my-dropzone").dropzone({
					url: "{{ url('/adminpanel/'.$worksInfo['works'].'/imageupload/'.$id) }}",
