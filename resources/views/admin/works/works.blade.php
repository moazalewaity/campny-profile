...
@section('title','عرض '.$worksInfo['title'])
       ...
       <div class="portlet light bordered">
              <div class="portlet-title">
                     <div class="caption font-red-sunglo">
                            ...
                            <span class="caption-subject bold uppercase"> بحث عن  {{ $worksInfo['title'] }}  </span>
                     </div>
              </div>
       ...
       <div class="portlet light bordered">
              ...
              <div class="portlet-title">
                     <div class="caption font-red-sunglo">
                            ...
                            <span class="caption-subject bold uppercase"> عرض {{ $worksInfo['title'] }}</span>
                     </div>
              </div>
              <div class="portlet-body form">
...
<script type="text/javascript">
       $(document).ready(function() {
              var oTable =  $('.datatable').DataTable({
                     ...
                     serverSide: true,
                     ajax: {
                            url: "{{ url('/adminpanel/works/getdata') }}" ,
                            data: function (d) {
                     ...
                     "fnDrawCallback" : function(settings, json){
                            $('.make-switch').bootstrapSwitch({
                                   ...
                                   onSwitchChange: function (event, state) {
                                          ...
                                          $.ajax({
                                            url: "{{ url('/adminpanel/'.$worksInfo['works'].'/changestatus') }}/" + id + "/"+state,
                                            type: "get",
              ...
              jQuery(document).ready( function ($){
                     $("#myTablesw tbody").sortable({
                            ...
                            stop: function(en , ui){
                                   ...
                                   $.ajax({
                                          url: "{{ url('/adminpanel/'.$worksInfo['works'].'/resort_table') }}",
                                          type: "post",
                                          data: {
                                                 "_token":"{{ csrf_token() }}",
                                                 "item":item
