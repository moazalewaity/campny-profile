        ...
        <div class="form-body">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    ...
                    placeholder="slug" id="slug" name="slug" required  data-error="{{ trans('mainpage.rule_name_slg') }}">
            ...
            <input type="text" class="form-control" placeholder="name"  required id="name" name="name"  data-error="{{ trans('mainpage.rule_name') }}">
            ...
            @foreach ($menues->user_permissions as $submenue)
              <div>
                ...
                <label style="display: inline-block;">
                  <a  class="btn btn-info btn-xs" onclick="$('.s_m').toggle()"><i class="fa fa-plus"></i></a>
                  {{$submenue['title']}}
                </label>
                <?php }else{?>
