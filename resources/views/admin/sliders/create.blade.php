...
@section('title','اضافة '.$slidersInfo['title'])
			...
			<div class="col-md-12">
				<div class="tabbable tabbable-custom tabbable-noborder tabbable-reversed">
					...
					<div class="tab-content">
						<form method="POST" action="{{ url('/adminpanel/'.$slidersInfo['sliders'].'/create/'.$id) }}" enctype="multipart/form-data">
							{{ csrf_field() }}
									...
									<div class="row">
										...
										<div class="col-md-12">
											<div class="form-group form-md-line-input">
												...
												<div class="col-md-10">
													<input type="text" class="form-control" id="subtitle" name="subtitle" value="{{ $data->subtitle or '' }}">
												</div>
										...
										<div class="col-md-12">
											<div class="form-group form-md-line-input">
												...
												<div class="col-md-10">
													<input type="text" class="form-control" id="subtitle_en" name="subtitle_en" value="{{ $data->subtitle_en or '' }}">
												</div>
										...
										<div class="col-md-12">
											<div class="form-group form-md-line-input">
												...
												@if ($errors->has('in_slider'))
												<span class="invalid-feedback" role="alert">
													<strong>{{ $errors->first('in_slider') }}</strong>
												</span>
												@endif
											</div>
										</div>
...
$.ajax({
url: "{{ url('/adminpanel/'.$slidersInfo['sliders'].'/resort') }}",
type: "post",
data: {
"_token":"{{ csrf_token() }}",
"item":item
...
console.log(item);
			...
			$("#my-dropzone").dropzone({
					url: "{{ url('/adminpanel/'.$slidersInfo['sliders'].'/imageupload/'.$id) }}",
