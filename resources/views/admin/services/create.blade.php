...
@section('title','اضافة '.$servicesInfo['title'])
			...
			<div class="col-md-12">
				<div class="tabbable tabbable-custom tabbable-noborder tabbable-reversed">
					...
					<div class="tab-content">
						<form method="POST" action="{{ url('/adminpanel/'.$servicesInfo['service'].'/create/'.$id) }}" enctype="multipart/form-data">
							{{ csrf_field() }}
									...
									<div class="row">
										...
										<div class="col-md-12">
											<div class="form-group form-md-line-input">
												...
												<div class="col-md-10">
													<input type="text" class="form-control" id="title" name="icon" value="{{ $data->icon or '' }}">
												</div>
												@if ($errors->has('title'))
												<span class="invalid-feedback" role="alert">
										...
										<div class="col-md-12">
											<div class="form-group form-md-line-input">
												<label class="col-md-2 control-label" for="descrption_en">{{ trans('mainpage.detils') }} - en </label>
												<div class="col-md-10">
...
$.ajax({
url: "{{ url('/adminpanel/'.$servicesInfo['service'].'/resort') }}",
type: "post",
data: {
"_token":"{{ csrf_token() }}",
"item":item
...
console.log(item);
			...
			$("#my-dropzone").dropzone({
					url: "{{ url('/adminpanel/'.$servicesInfo['service'].'/imageupload/'.$id) }}",
