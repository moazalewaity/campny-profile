           ...
           <div class="page-header-inner ">
               ...
               <div class="page-logo" style="text-align: center" >
                   <a href="{{url('/adminpanel/')}}">
                       {{-- <img src="{{url('/')}}/admin/assets/layouts/layout2/img/logo-default.png" alt="logo" class="logo-default"  /> --}}
                       <img src="{{url('/')}}/img/logo.png" width="50" height="50" alt="" style="height:auto" />
                 ...
                 <!--  <form class="search-form search-form-expanded" action="page_general_search_3.html" method="GET">
                   ...
                   <div class="top-menu">
                       <ul class="nav navbar-nav pull-right">
                          ...
                          <!--         <li class="external">-->
                          <!--             <h3>-->
                          <!--                 <span class="bold">{{ trans('mainpage.menu_notoficlast') }} </span> {{ trans('mainpage.menu_notofic') }} </h3>-->
                          ...
                          <!-- </li> -->
                           ...
                           <!--    <ul class="dropdown-menu">-->
                           <!--        <li class="external">-->
                           <!--            <h3>{{ trans('mainpage.menu_newmessage') }}</h3>                                       -->
                           <!--        </li>-->
                           <!--        <li>-->
             ...
             <!--              <li class="dropdown dropdown-extended dropdown-tasks" id="header_task_bar">
                           ...
                           <!--                     <a href="{{url('/adminpanel/user/userlangs/'.$row->id)}}">{{ $row->name }}</a>-->
                            ...
                            <li class="dropdown dropdown-user">
                                ...
                                <ul class="dropdown-menu dropdown-menu-default">
                                    ...
                                    <li>
                                        ...
                                        <a href="{{url('/adminpanel/user/update_password')}}">

                                            <i class="icon-lock"></i>{{ trans('mainpage.menu_changepas') }}  </a>

                                    </li> 

                                    <li>

                                        <a href="{{url('/adminpanel/logout')}}" ><i class="icon-key"></i>{{ trans('mainpage.menu_logout') }} </a>
