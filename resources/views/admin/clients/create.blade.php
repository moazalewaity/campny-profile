...
@section('title','اضافة '.$clientsInfo['title'])
			...
			<div class="col-md-12">
				<div class="tabbable tabbable-custom tabbable-noborder tabbable-reversed">
					...
					<div class="tab-content">
						<form method="POST" action="{{ url('/adminpanel/'.$clientsInfo['clients'].'/create/'.$id) }}" enctype="multipart/form-data">
							{{ csrf_field() }}
									...
									<div class="row">
										...
										<div class="col-md-12">
											<div class="form-group form-md-line-input">
												...
												<div class="col-md-10">
													<input type="text" class="form-control" id="name_en" name="name_en" value="{{ $data->name_en or '' }}">
												</div>
										...
										<div class="col-md-12">
											<div class="form-group form-md-line-input">
												...
												<div class="col-md-10">
													<input type="text" class="form-control" id="addres" name="addres" value="{{ $data->addres or '' }}">
												</div>
										...
										<div class="col-md-12">
											<div class="form-group form-md-line-input">
												...
												<div class="col-md-10">
													<input type="file" class="form-control" id="iamge" name="iamge" value="{{ $data->iamge or '' }}">
												</div>
												@if ($errors->has('iamge'))
												<span class="invalid-feedback" role="alert">
...
$.ajax({
url: "{{ url('/adminpanel/'.$clientsInfo['clients'].'/resort') }}",
type: "post",
data: {
"_token":"{{ csrf_token() }}",
"item":item
...
console.log(item);
			...
			$("#my-dropzone").dropzone({
					url: "{{ url('/adminpanel/'.$clientsInfo['clients'].'/imageupload/'.$id) }}",
