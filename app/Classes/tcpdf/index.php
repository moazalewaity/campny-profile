...
$pdf->SetAuthor('مصطفى العامري');
$pdf->SetTitle('اللغة العربية');
$pdf->SetSubject('حل مشكلة اللغة العربية');
$pdf->SetKeywords('تحويل اتش تي امل الى بي دي اف اللغة العربية');
...
$htmlcontent = 'حلّ مشكلة الكتابة باللغة العربية في ملفات الـ<span color="#FF0000">PDF</span> مع دعم الكتابة <span color="#0000FF">من اليمين إلى اليسار</span> و<span color="#009900">الحركَات</span> .<br /> - <span color="#993399">مصطفى العامري</span> - نص تجريبي ( '.$_GET['text']." ).";
