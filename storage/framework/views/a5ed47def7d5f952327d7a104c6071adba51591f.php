<?php $__env->startSection('title','القوائم'); ?>
       ...
       <div class="portlet light bordered">
              <div class="portlet-title">
                     <div class="caption font-red-sunglo">
                            ...
                            <span class="caption-subject bold uppercase"> <?php echo e(trans('mainpage.engeuiry')); ?></span>
                     </div>
              </div>
              <div class="portlet-body form">
                     <form method="POST" id="search_form" class="form-inline" role="form">
                            ...
                            <button type="submit" class="btn btn-primary"><?php echo e(trans('mainpage.save')); ?></button>
                     </form>
              </div>
       </div>
       <div class="portlet light bordered">
              <div class="portlet-title">
                     <div class="caption font-red-sunglo">
                            ...
                            <span class="caption-subject bold uppercase"><?php echo e(trans('mainpage.view_dep')); ?></span>
                     </div>
              </div>
              <div class="portlet-body form">
                            ...
                            <table class="table table-bordered datatable" id="myTablesw">
                                   <thead>
                                          <tr>
                                                 ...
                                                 <th><?php echo e(trans('mainpage.name_dep')); ?></th>
                                                 <th><?php echo e(trans('mainpage.image_dep')); ?></th>
                                                 <th><?php echo e(trans('mainpage.icon')); ?></th>
                                                 <th><?php echo e(trans('mainpage.bannar')); ?></th>
                                                 <th><?php echo e(trans('mainpage.color')); ?></th>
...
<script type="text/javascript">
       $(document).ready(function() {
              ...
              var oTable =  $('.datatable').DataTable({
                     ...
                     serverSide: true,
                     ajax: {
                            url: '<?php echo e(route("department/getdata")); ?>' ,
                            data: function (d) {
                     ...
                     columns: [
                            ...
                            {data: 'image', render: function(data){
                                          var items = data;
                                          var item = '<?php echo e(url("media/department/img/")); ?>';
                            ...
                            {data: 'icon', render: function(data){
                                   var items = data;
                                   var item = '<?php echo e(url("media/department/icon/")); ?>';
                                   if(data && data != 'defulte.png'){
                            ...
                            {data: 'banner', render: function(data){
                                   var items = data;
                                   var item = '<?php echo e(url("media/department/banner/")); ?>';
                                   if(data && data != 'defulte.png'){
       ...
       jQuery(document).ready( function ($){
              $("#myTablesw tbody").sortable({
                     ...
                     stop: function(en , ui){
                            ...
                            $.ajax({
                                   url: "<?php echo e(url('/')); ?>/department/resort_table",
                                   type: "post",
                                   data: {
