...
<html lang="en" dir="rtl">
    ...
    <head>
        ...
        <link href="<?php echo e(url('/')); ?>/admin/assets/global/plugins/bootstrap/css/bootstrap-rtl.min.css" rel="stylesheet" type="text/css" />



        <link href="<?php echo e(url('/')); ?>/admin/assets/global/plugins/bootstrap-switch/css/bootstrap-switch-rtl.min.css" rel="stylesheet" type="text/css" />
        ...
        <link href="<?php echo e(url('/')); ?>/admin/assets/global/css/components-rtl.min.css" rel="stylesheet" id="style_components" type="text/css" />



        <link href="<?php echo e(url('/')); ?>/admin/assets/global/css/plugins-rtl.min.css" rel="stylesheet" type="text/css" />
        ...
        <link href="<?php echo e(url('/')); ?>/admin/assets/pages/css/login-rtl.min.css" rel="stylesheet" type="text/css" />
        ...
        <!-- END THEME LAYOUT STYLES -->
         ...
         <link rel="shortcut icon" href="<?php echo e(url('/')); ?>/admin/assets/layouts/layout2/img/favicon.ico" /> </head>
    ...
    <body class=" login">
        ...
        <div class="logo">
            ...
            <a href="index.html" style="text-decoration: none">
                ...
                <img src="<?php echo e(url('/')); ?>/img/logo.png" width="100" height="100" alt="" style="height:auto" />
                <h2><?php echo e($setting->title); ?></h2>
             </a>

            <!-- <img src="<?php echo e(url('/')); ?>/admin/image.png" title="Happy New Year 2019"> -->
        ...
        <div class="content">
            ...
            <form class="login-form" action="<?php echo e(url('/adminpanel/login')); ?>" method="post">
           ...
           <?php echo $__env->make('admin.content.fpassword', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
           ...
           <?php echo $__env->make('admin.content.register', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<![endif]-->
        ...
        <script src="<?php echo e(url('/')); ?>/admin/assets/pages/scripts/login.min.js" type="text/javascript"></script>
