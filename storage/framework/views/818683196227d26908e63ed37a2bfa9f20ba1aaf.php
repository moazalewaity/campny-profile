<?php $__env->startSection('title','عرض '.$postInfo['title']); ?>
       ...
       <div class="portlet light bordered">
              ...
              <div class="portlet-title">
                     <div class="caption font-red-sunglo">
                            ...
                            <span class="caption-subject bold uppercase"> <?php echo e(trans('mainpage.view_posts')); ?></span>
                     </div>
              </div>
              <div class="portlet-body form">
                            ...
                            <table class="table table-bordered datatable" id="myTablesw">
                                   <thead>
                                          <tr>
                                                 ...
                                                 <th><?php echo e(trans('mainpage.address_posts')); ?></th>
                                                 <th><?php echo e(trans('mainpage.menu')); ?></th>
                                                 <th><?php echo e(trans('mainpage.image_post')); ?></th>
                                                 <th><?php echo e(trans('mainpage.user')); ?></th>
...
<script type="text/javascript">
       $(document).ready(function() {
              var oTable =  $('.datatable').DataTable({
                     ...
                     serverSide: true,
                     ajax: {
                            url: "<?php echo e(url('/adminpanel/'.$postInfo['service'].'/getdata')); ?>" ,
                            data: function (d) {
                     ...
                     columns: [
                            ...
                            {data: 'image', render: function(data){
                                          var items = data;
                                          var item = '<?php echo e(url("media/post/gallery/")); ?>';
                     ...
                     "fnDrawCallback" : function(settings, json){
                            $('.make-switch').bootstrapSwitch({
                                   ...
                                   onSwitchChange: function (event, state) {
                                          ...
                                          $.ajax({
                                            url: "<?php echo e(url('/adminpanel/'.$postInfo['service'].'/changestatus')); ?>/" + id + "/"+state,
                                            type: "get",
              ...
              jQuery(document).ready( function ($){
                     $("#myTablesw tbody").sortable({
                            ...
                            stop: function(en , ui){
                                   ...
                                   $.ajax({
                                          url: "<?php echo e(url('/adminpanel/'.$postInfo['service'].'/resort_table')); ?>",
                                          type: "post",
                                          data: {
