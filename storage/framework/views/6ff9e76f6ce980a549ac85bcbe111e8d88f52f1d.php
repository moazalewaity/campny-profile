<?php $__env->startSection('title','اضافة '.$clientsInfo['title']); ?>
			...
			<div class="col-md-12">
				<div class="tabbable tabbable-custom tabbable-noborder tabbable-reversed">
					...
					<div class="tab-content">
						<form method="POST" action="<?php echo e(url('/adminpanel/'.$clientsInfo['clients'].'/create/'.$id)); ?>" enctype="multipart/form-data">
							...
							<div class="tab-pane active" id="tab_90">
								<div class="form-body">
									<div class="row">
										...
										<div class="col-md-12">
											<div class="form-group form-md-line-input">
												<label class="col-md-2 control-label" for="addres">  العنوان   </label>
												<div class="col-md-10">
													<input type="text" class="form-control" id="addres" name="addres" value="<?php echo e(isset($data->addres) ? $data->addres : ''); ?>">
												</div>
												<?php if($errors->has('addres')): ?>
												<span class="invalid-feedback" role="alert">
										...
										<div class="col-md-12">
											<div class="form-group form-md-line-input">
												<label class="col-md-2 control-label" for="iamge"> الصورة  </label>
												<div class="col-md-10">
													<input type="file" class="form-control" id="iamge" name="iamge" value="<?php echo e(isset($data->iamge) ? $data->iamge : ''); ?>">
												</div>
												<?php if($errors->has('iamge')): ?>
												<span class="invalid-feedback" role="alert">
													<strong><?php echo e($errors->first('iamge')); ?></strong>
												</span>
												<?php endif; ?>
										...
										<div class="col-md-12">
											<div class="form-group form-md-line-input">
												<label class="col-md-2 control-label" for="description"> راى العميل </label>
												<div class="col-md-10">
										...
										<div class="col-md-12">
											<div class="form-group form-md-line-input">
												<label class="col-md-2 control-label" for="descrption_en"> راى العميل  - en </label>
												<div class="col-md-10">
													<textarea class="form-control" id="descrption_en" name="descrption_en[]"><?php if(isset($data->descrption_en)){ echo $data->descrption_en; } ?></textarea>
												</div>
							...
							<?php if($clientsInfo['showembdtab']): ?>
							...
							<?php endif; ?>
							<?php if($clientsInfo['showlinktab']): ?>
...
$.ajax({
url: "<?php echo e(url('/adminpanel/'.$clientsInfo['clients'].'/resort')); ?>",
type: "post",
data: {
...
console.log(item);
			...
			$("#my-dropzone").dropzone({
					url: "<?php echo e(url('/adminpanel/'.$clientsInfo['clients'].'/imageupload/'.$id)); ?>",
