<?php $__env->startSection('title','عرض '.$concatsInfo['title']); ?>
       ...
       <div class="portlet light bordered">
              <div class="portlet-title">
                     <div class="caption font-red-sunglo">
                            ...
                            <span class="caption-subject bold uppercase"> بحث عن  <?php echo e($concatsInfo['title']); ?>  </span>
                     </div>
              </div>
       ...
       <div class="portlet light bordered">
              ...
              <div class="portlet-title">
                     <div class="caption font-red-sunglo">
                            ...
                            <span class="caption-subject bold uppercase"> عرض <?php echo e($concatsInfo['title']); ?></span>
                     </div>
              </div>
              <div class="portlet-body form">
...
<script type="text/javascript">
       $(document).ready(function() {
              var oTable =  $('.datatable').DataTable({
                     ...
                     serverSide: true,
                     ajax: {
                            url: "<?php echo e(url('/adminpanel/concats/getdata')); ?>" ,
                            data: function (d) {
                    ...
                    "language": {
                     ...
                     "fnDrawCallback" : function(settings, json){
                            $('.make-switch').bootstrapSwitch({
                                   ...
                                   //        $.ajax({
                                   //          url: "<?php echo e(url('/adminpanel/'.$concatsInfo['concats'].'/changestatus')); ?>/" + id + "/"+state,
                                   //          type: "get",
              ...
              jQuery(document).ready( function ($){
                     $("#myTablesw tbody").sortable({
                            ...
                            stop: function(en , ui){
                                   ...
                                   $.ajax({
                                          url: "<?php echo e(url('/adminpanel/'.$concatsInfo['concats'].'/resort_table')); ?>",
                                          type: "post",
                                          data: {
