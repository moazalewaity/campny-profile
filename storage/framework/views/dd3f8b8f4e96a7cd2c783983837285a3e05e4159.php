<?php $__env->startSection('title','اضافة '.$servicesInfo['title']); ?>
			...
			<div class="col-md-12">
				<div class="tabbable tabbable-custom tabbable-noborder tabbable-reversed">
					...
					<div class="tab-content">
						<form method="POST" action="<?php echo e(url('/adminpanel/'.$servicesInfo['service'].'/create/'.$id)); ?>" enctype="multipart/form-data">
							...
							<div class="tab-pane active" id="tab_90">
								<div class="form-body">
									<div class="row">
										...
										<div class="col-md-12">
											<div class="form-group form-md-line-input">
												<label class="col-md-2 control-label" for="title_en"> en - العنوان </label>
												<div class="col-md-10">
										...
										<div class="col-md-12">
											<div class="form-group form-md-line-input">
												<label class="col-md-2 control-label" for="icon"> الايقونة  </label>
												<div class="col-md-10">
													<input type="text" class="form-control" id="title" name="icon" value="<?php echo e(isset($data->icon) ? $data->icon : ''); ?>">
												</div>
												<?php if($errors->has('title')): ?>
												<span class="invalid-feedback" role="alert">
												...
												<span  class="invalid-feedback">
													<a target="_new" href="https://fontawesome.com/icons?d=listing&m=free">
														اختيار الايقونة 
													</a>
													<a target="_new" href="https://ionicons.com/">
														رابط اخر 
													</a>
										...
										<div class="col-md-12">
											<div class="form-group form-md-line-input">
												<label class="col-md-2 control-label" for="descrption_en"><?php echo e(trans('mainpage.detils')); ?> - en </label>
												<div class="col-md-10">
							...
							<?php if($servicesInfo['showembdtab']): ?>
							...
							<?php endif; ?>
							<?php if($servicesInfo['showlinktab']): ?>
...
$.ajax({
url: "<?php echo e(url('/adminpanel/'.$servicesInfo['service'].'/resort')); ?>",
type: "post",
data: {
...
console.log(item);
			...
			$("#my-dropzone").dropzone({
					url: "<?php echo e(url('/adminpanel/'.$servicesInfo['service'].'/imageupload/'.$id)); ?>",
