<?php $__env->startSection('title','اضافة '.$worksInfo['title']); ?>
			...
			<div class="col-md-12">
				<div class="tabbable tabbable-custom tabbable-noborder tabbable-reversed">
					...
					<div class="tab-content">
						<form method="POST" action="<?php echo e(url('/adminpanel/'.$worksInfo['works'].'/create/'.$id)); ?>" enctype="multipart/form-data">
							...
							<div class="tab-pane active" id="tab_90">
								<div class="form-body">
									<div class="row">
										...
										<div class="col-md-12">
											<div class="form-group form-md-line-input">
												<label class="col-md-2 control-label" for="title">  العنوان  - en </label>
												<div class="col-md-10">
										...
										<div class="col-md-12">
											<div class="form-group form-md-line-input">
												<label class="col-md-2 control-label" for="client">  اسم العميل   </label>
												<div class="col-md-10">
													<input type="text" class="form-control" id="client" name="client" value="<?php echo e(isset($data->client) ? $data->client : ''); ?>">
												</div>
										...
										<div class="col-md-12">
											<div class="form-group form-md-line-input">
												<label class="col-md-2 control-label" for="date">  تاريخ المشروع  </label>
												<div class="col-md-10">
													<input type="date" class="form-control" id="date" name="date" value="<?php echo e(isset($data->date) ? $data->date : ''); ?>">
												</div>
										...
										<div class="col-md-12">
											<div class="form-group form-md-line-input">
												<label class="col-md-2 control-label" for="url">  رابط المشروع   </label>
												<div class="col-md-10">
													<input type="text" class="form-control"  name="url_work" value="<?php echo e(isset($data->url) ? $data->url : ''); ?>">
												</div>
										...
										<div class="col-md-12">
											<div class="form-group form-md-line-input">
												<label class="col-md-2 control-label" for="description">وصف المشروع  </label>
												<div class="col-md-10">
													<textarea class="form-control" id="descrption" name="descrption[]">
														<?php if(isset($data->descrption)){ echo $data->descrption; } ?>
													</textarea>
												</div>
										...
										<div class="col-md-12">
											<div class="form-group form-md-line-input">
												<label class="col-md-2 control-label" for="description">وصف المشروع  -en </label>
												<div class="col-md-10">
													<textarea class="form-control" id="descrption_en" name="descrption_en[]">
														<?php if(isset($data->descrption_en)){ echo $data->descrption_en; } ?>
													</textarea>
												</div>
												<?php if($errors->has('descrption_en')): ?>
												<span class="invalid-feedback" role="alert">
													<strong><?php echo e($errors->first('descrption_en')); ?></strong>
												</span>
												<?php endif; ?>
											</div>
										</div>
...
$.ajax({
url: "<?php echo e(url('/adminpanel/'.$worksInfo['works'].'/resort')); ?>",
type: "post",
data: {
...
console.log(item);
			...
			$("#my-dropzone").dropzone({
					url: "<?php echo e(url('/adminpanel/'.$worksInfo['works'].'/imageupload/'.$id)); ?>",
