<?php $__env->startSection('title','عرض '.$slidersInfo['title']); ?>
       ...
       <div class="portlet light bordered">
              <div class="portlet-title">
                     <div class="caption font-red-sunglo">
                            ...
                            <span class="caption-subject bold uppercase"> بحث عن  <?php echo e($slidersInfo['title']); ?>  </span>
                     </div>
              </div>
       ...
       <div class="portlet light bordered">
              ...
              <div class="portlet-title">
                     <div class="caption font-red-sunglo">
                            ...
                            <span class="caption-subject bold uppercase"> عرض <?php echo e($slidersInfo['title']); ?></span>
                     </div>
              </div>
              <div class="portlet-body form">
...
<script type="text/javascript">
       $(document).ready(function() {
              var oTable =  $('.datatable').DataTable({
                     ...
                     serverSide: true,
                     ajax: {
                            url: "<?php echo e(url('/adminpanel/sliders/getdata')); ?>" ,
                            data: function (d) {
                     ...
                     columns: [
                            ...
                            {data: 'image', render: function(data){
                                          var items = data;
                                          var item = '<?php echo e(url("media/sliders/img/")); ?>';
                     ...
                     "fnDrawCallback" : function(settings, json){
                            $('.make-switch').bootstrapSwitch({
                                   ...
                                   onSwitchChange: function (event, state) {
                                          ...
                                          $.ajax({
                                            url: "<?php echo e(url('/adminpanel/'.$slidersInfo['sliders'].'/changestatus')); ?>/" + id + "/"+state,
                                            type: "get",
              ...
              jQuery(document).ready( function ($){
                     $("#myTablesw tbody").sortable({
                            ...
                            stop: function(en , ui){
                                   ...
                                   $.ajax({
                                          url: "<?php echo e(url('/adminpanel/'.$slidersInfo['sliders'].'/resort_table')); ?>",
                                          type: "post",
                                          data: {
